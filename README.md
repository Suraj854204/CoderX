...
Built for the **Snapdragon® Multiverse Hackathon** (Bangalore) — Top 50 Teams
(India level), Phase 2 build. After the build phase ended, our team was
selected among the top 8 finalists out of all 50 teams and presented live
on stage in the final battle — **finishing 2nd overall, 0.5 points behind
1st place.**
...
```bash
cd backend
python tests/test_pipeline.py -v   # 20 tests, stdlib-only, no pytest needed
```
